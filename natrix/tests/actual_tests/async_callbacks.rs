#![cfg(all(feature = "async", feature = "web_utils"))]

use std::time::Duration;

use natrix::prelude::*;
use natrix::web_utils;
...
async fn async_works() {
    ...
    button.click();
    web_utils::sleep(Duration::from_millis(300)).await;
...
async fn async_multiple() {
    ...
    button.click();
    button.click();
    web_utils::sleep(Duration::from_millis(400)).await;
